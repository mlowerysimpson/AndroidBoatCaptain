...
public class NetCaptain extends Captain {
	 ...
	 * for an image was received, it does not return the actual image data. The m_nNumImageBytes variable contains the size of the image that is available for download from AMOS. The image must be downloaded
